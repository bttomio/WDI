...
subtitle: "&#x26f0;&#xfe0f; R in Grenoble - Working Sessions"  
author: 
  - "Bruno Thiago Tomio"
...
library(metathis)
meta() %>%
  meta_name("github-repo" = "bttomio/WDI") %>% 
  meta_social(
    title = "Collect and use open access World Bank data to know your country",
    description = paste(
      "Introduction to the R package WDI.",
      "Presented at R in Grenoble - Working Sessions 2020."
    ),
    url = "https://bttomio.github.io/slides/WDI/Slides.html",
    image = "https://bttomio.github.io/slides/WDI/share-card.png",
    image_alt = paste(
      "Collect and use open access World Bank data to know your country,", 
      "presented at R in Grenoble - Working Sessions 2020 by Bruno Thiago Tomio"
    ),
    og_type = "website",
...
### &#x26f0;&#xfe0f; R in Grenoble - Working Sessions
...
<a href="https://github.com/bttomio/WDI"><img style="position: absolute; top: 0; left: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_left_white_ffffff.png" alt="Fork me on GitHub"></a>
...
# World Bank data in `r icon::fontawesome$brands$"r-project"`
...
icon_style(fontawesome("twitter", style = "brands"), size = 1, color = "white")
```

`r icon::fontawesome$solid$cog` [`bttomio@furb.br`](bttomio@furb.br)

`r icon::fontawesome$brands$twitter` [@bttomio](https://twitter.com/bttomio)
]
